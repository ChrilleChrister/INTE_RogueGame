...
public class MonsterSlayingObjectiveTest {
    ...
    public void testMonsterSlayingObjectiveCtrSetsAttributes() {
        MonsterSlayingObjective objective = new MonsterSlayingObjective(DEFAULT_MONSTER_NAME, DEFAULT_NUMBER_TO_SLAY);
    ...
    public void testMonsterSlayingObjectiveCtrThrowsIAEIfNumberToSlayIsLessThanOne() {
        new MonsterSlayingObjective(DEFAULT_MONSTER_NAME, -1);
    }

    @Test (expected = IllegalArgumentException.class)
    public void testMonsterTypeCanNotBeNull() {
        new MonsterSlayingObjective(null, DEFAULT_NUMBER_TO_SLAY);
    }

    @Test
    public void testStatusMessageIsEmptyForNewQuest() {
        QuestObjective objective = new MonsterSlayingObjective(DEFAULT_MONSTER_NAME, DEFAULT_NUMBER_TO_SLAY);
